#Maximale Änderung nach vorne und hinten 10 Minuten (innerhalb Zeitkorridor 40 Minuten)
import itertools
...
s2_start = [20,25,30]
s3_start = [10,15,20]
s4_start = [25,30,35,40,45,50]
s5_start = [10,15,20,25,30]
s6_start = [30,35,40,45,50]
s7_start = [20,25,30,35,40,45,50,55,65]
