#Maximale Änderung  hinten 30 Minuten (innerhalb Zeitkorridor 60 Minuten)
import itertools
...
s1_start = [20,30,40]
s2_start = [20,30,40,50]
s3_start = [15,20,30,40]
s4_start = [40,50,60,70]
s5_start = [20,30,40,50]
s6_start = [40,50,60,70]
s7_start = [20,30,40,50]
