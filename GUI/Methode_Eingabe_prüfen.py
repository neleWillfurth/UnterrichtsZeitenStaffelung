...
def eingabe_prüfen(aktueller_unterrichtsbeginn_alle_Schulen_entries, Spaetere_Ankuenfte, Weg_Bus_Schule, scrollable_tab2, button_werteingabe_bestätigen, button_eingabe_prüfen):
    results = []
