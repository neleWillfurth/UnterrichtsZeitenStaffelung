#Maximale Änderung nach vorne 10 Minuten und hinten 20 Minuten (innerhalb Zeitkorridor 40 Minuten)
import itertools
...
s1_start = [10,20,30]
s2_start = [10,20,30,40]
s3_start = [5,10,20,30]
s4_start = [30,40,50,60]
s5_start = [10,20,30,40]
s6_start = [30,40,50,60]
s7_start = [10,20,30,40]
