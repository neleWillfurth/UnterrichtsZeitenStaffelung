...
Busse_hohes_Einsparpotenzial = int(19500*1.15/Teiler)+1
...
while Durchläufe < Busse_hohes_Einsparpotenzial:
    indices = [i for i, x in enumerate(n_reuses) if x == max_reuses - Durchläufe]
    indices_of_values.append(indices)
    Durchläufe += 1
...
for Durchläufe in range(max_reuses-Busse_hohes_Einsparpotenzial):
