...
s1_start = [25,30,35,40,45,50,55]
s2_start = [25,30,35,40,45,50,55,60]
s3_start = [15,20,25,30,35,40,45,50,55]
s4_start = [30,35,40,45,50,55,60]
s5_start = [25,30,35,40,45,50,55,60,65]
s6_start = [35,40,45,50,55,60,65]
s7_start = [25,30,35,40,45,50,55,60,65]
...
print (f"Mit folgenden Varianten werden {max_reuses-1}Busse gespart")
for q in indices_of_second_highest_value:
    print(schoolstart_combination[q])
print(len(indices_of_second_highest_value))

print (f"Mit folgenden Varianten werden {max_reuses-2}Busse gespart")
for q in indices_of_third_highest_value:
    print(schoolstart_combination[q])
print(len(indices_of_third_highest_value))

print (f"Mit folgenden Varianten werden {max_reuses-3}Busse gespart")
for q in indices_of_fourth_highest_value:
    print(schoolstart_combination[q])
print(len(indices_of_fourth_highest_value))

print (f"Mit folgenden Varianten werden {max_reuses-4}Busse gespart")

for q in indices_of_fivest_highest_value:
    print(schoolstart_combination[q])
print(len(indices_of_fivest_highest_value))
