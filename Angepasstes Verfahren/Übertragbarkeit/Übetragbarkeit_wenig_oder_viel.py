...
# Total minutes and number of elements
total_minutes = 140
num_elements = 7
...
for combination in partitions:
    ...
    if combination[0] == 140:
        s1_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[1] == 140:
        s2_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[2] == 140:
        s3_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[3] == 140:
        s4_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[4] == 140:
        s5_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[5] == 140:
        s6_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])
    if combination[6] == 140:
        s7_start.extend([-10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130])

    if combination[0] == 70:
        s1_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[1] == 70:
        s2_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[2] == 70:
        s3_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[3] == 70:
        s4_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[4] == 70:
        s5_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[5] == 70:
        s6_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])
    if combination[6] == 70:
        s7_start.extend([25, 30, 35, 40, 45, 50, 55, 65, 70, 75, 80, 85, 90, 95])

    if combination[0] == 35:
        s1_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[1] == 35:
        s2_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[2] == 35:
        s3_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[3] == 35:
        s4_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[4] == 35:
        s5_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[5] == 35:
        s6_start.extend([45, 50, 55, 65, 70, 75, 80])
    if combination[6] == 35:
        s7_start.extend([45, 50, 55, 65, 70, 75, 80])

    if combination[0] == 28:
        s1_start.extend([45, 50, 55, 65, 70, 75])
    if combination[1] == 28:
        s2_start.extend([45, 50, 55, 65, 70, 75])
    if combination[2] == 28:
        s3_start.extend([45, 50, 55, 65, 70, 75])
    if combination[3] == 28:
        s4_start.extend([45, 50, 55, 65, 70, 75])
    if combination[4] == 28:
        s5_start.extend([45, 50, 55, 65, 70, 75])
    if combination[5] == 28:
        s6_start.extend([45, 50, 55, 65, 70, 75])
    if combination[6] == 28:
        s7_start.extend([45, 50, 55, 65, 70, 75])

    if combination[0] == 20:
        s1_start.extend([50, 55, 65, 70])

    if combination[1] == 20:
        s2_start.extend([50, 55, 65, 70])

    if combination[2] == 20:
        s3_start.extend([50, 55, 65, 70])

    if combination[3] == 20:
        s4_start.extend([50, 55, 65, 70])

    if combination[4] == 20:
        s5_start.extend([50, 55, 65, 70])

    if combination[5] == 20:
        s6_start.extend([50, 55, 65, 70])

    if combination[6] == 20:
        s7_start.extend([50, 55, 65, 70])
...
filtered_n_reuses_140 = [n_reuses [i] for i in range(len(partitions)) if 140 in partitions]
filtered_n_reuses_70 = [n_reuses [i] for i in range(len(partitions)) if 70 in partitions]
filtered_n_reuses_35 = [n_reuses [i] for i in range(len(partitions)) if 35 in partitions]
filtered_n_reuses_28 = [n_reuses [i] for i in range(len(partitions)) if 28 in partitions]
filtered_n_reuses_20 = [n_reuses [i] for i in range(len(partitions)) if 20 in partitions]



mean_n_reuses140 = np.mean(filtered_n_reuses_140)
mean_n_reuses70 = np.mean(filtered_n_reuses_70)
mean_n_reuses35 = np.mean(filtered_n_reuses_35)
mean_n_reuses28= np.mean(filtered_n_reuses_28)
mean_n_reuses20 =np.mean(filtered_n_reuses_20)


print("140",mean_n_reuses140)
print("70",mean_n_reuses70)
print("35",mean_n_reuses35)
print("28",mean_n_reuses28)
print("20",mean_n_reuses20)
