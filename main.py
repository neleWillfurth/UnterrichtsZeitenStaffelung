...
# Startuhrzeiten der Schulen festlegen in Minuten ab 7:10
s1_start = range(0, 61, 10)
s2_start = range(0, 61, 10)
s3_start = range(0, 61, 10)
s4_start = range(0, 61, 10)
s5_start = range(0, 61, 10)
s6_start = range(0, 61, 10)
s7_start = range(0, 61, 10)
